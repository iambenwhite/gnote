...
func (e *cecpq1Curve) accept(rand io.Reader, peerKey []byte) (publicKey []byte, preMainSecret []byte, err error) {
...
func (e *cecpq1Curve) finish(peerKey []byte) (preMainSecret []byte, err error) {
...
func (ka *cecpq1KeyAgreement) generateClientKeyExchange(config *Config, clientHello *clientHelloMsg, cert *x509.Certificate) ([]byte, *clientKeyExchangeMsg, error) {
	curve := &cecpq1Curve{}
	publicKey, preMainSecret, err := curve.accept(config.rand(), ka.peerKey)
	if err != nil {
		return nil, nil, err
	}
