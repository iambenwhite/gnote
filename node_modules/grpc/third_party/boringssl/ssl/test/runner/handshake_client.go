...
func (hs *clientHandshakeState) doTLS13Handshake() error {
	...
	if hs.suite.flags&suitePSK != 0 {
		...
		psk = deriveResumptionPSK(hs.suite, hs.session.mainSecret)
		hs.finishedHash.setResumptionContext(deriveResumptionContext(hs.suite, hs.session.mainSecret))
		c.didResume = true
	} else {
		if hs.serverHello.hasPSKIdentity {
	...
	mainSecret := hs.finishedHash.extractKey(handshakeSecret, zeroSecret)
